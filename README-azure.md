...
Configure your credentials the same way as [Azure Blob Storage](https://github.com/apatil4/goofys/blob/master/README-azure.md#azure-blob-storage) above, and then:
