...
[![Github All Releases](https://img.shields.io/github/downloads/kahing/goofys/total.svg)](https://github.com/apatil4/goofys/releases/)
...
[catfs](https://github.com/apatil4/catfs)), and consistency model is
close-to-open.

# Installation

* On Linux, install via [pre-built binaries](https://github.com/apatil4/goofys/releases/latest/download/goofys). 
...
$ go get github.com/apatil4/goofys
$ go install github.com/apatil4/goofys
```
...
See also: [Instruction for Azure Blob Storage, Azure Data Lake Gen1, and Azure Data Lake Gen2](https://github.com/apatil4/goofys/blob/master/README-azure.md).

Got more questions? Check out [questions other people asked](https://github.com/apatil4/goofys/issues?utf8=%E2%9C%93&q=is%3Aissue%20label%3Aquestion%20)
...
[bench.sh](https://github.com/apatil4/goofys/blob/master/bench/bench.sh). [Raw data](https://github.com/apatil4/goofys/blob/master/bench/)
...
See also: [cached benchmark result](https://github.com/apatil4/goofys/blob/master/bench/cache/README.md) and [result on Azure](https://github.com/apatil4/goofys/blob/master/bench/azure/README.md).
...
# References
  ...
  * Other related fuse filesystems
    * [catfs](https://github.com/apatil4/catfs): caching layer that can be used with goofys
